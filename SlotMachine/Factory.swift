...
//  SlotMachine
//
//  Created by ANIL PACHHAI on 4/6/15.
...
class Factory {
    ...
    class func createSlots() ->[[Slot]] {
        ...
        var slots: [[Slot]] = []
        // slots = [ [slot1,slot2],[slot3,slot3, slot4, slot5],[slot6] ]
        // mySlotArray = slot[0] // THis means slot1, slot2
        //slot = mySlotArray[1] // this means slot2
        // this code below will look like this: slots = [ [slot1,slot2,slot3],[slot4,slot5,slot6], [slot7,slot8,slot9]]
