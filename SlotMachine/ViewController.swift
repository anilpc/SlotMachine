...
//  SlotMachine
//
//  Created by ANIL PACHHAI on 3/18/15.
...
class ViewController: UIViewController {
    ...
    func setupThirdContainer (containerView: UIView) {
        ...
        self.creditsTitleLabel.font = UIFont(name: "AmericanTypewriter", size: 14.0)
        ...
        self.betTitleLabel.font = UIFont(name: "AmericanTypewriter", size: 14.0)
        ...
        self.winnerPaidTitleLabel.font = UIFont(name: "AmericanTypewriter", size: 14.0)
        ...
        func setupFourthContainer(containerView: UIView) {
            ...
            self.resetButton.titleLabel?.font = UIFont(name: "Superclarendon-Bold", size: 12.0)
